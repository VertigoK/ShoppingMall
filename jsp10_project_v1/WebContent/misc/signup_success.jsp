	...
	<div class="container" align="center">
		<c:choose>
			<c:when test="<%= member != null %>">	
				<div class="jumbotron">
					<h3><%=member.getMem_name()%>님의 가입을 환영합니다!</h3>
				</div>
		...
		<br /><br /><br />
		<div>
			<img src="https://static.vecteezy.com/system/resources/previews/000/412/634/non_2x/handwritten-welcome-calligraphy-lettering-word-vector-illustration-on-white-background.jpg"
				 alt="signup_success" width="100%"/>
		</div>		
	</div>
</body>
</html>